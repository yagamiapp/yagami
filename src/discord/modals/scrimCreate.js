...
module.exports = {
    ...
    let team1 = interaction.fields.getTextInputValue("team1")
      .split("\n")
      .filter(x => x != "");
    let team2 = interaction.fields.getTextInputValue("team2")
      .split("\n")
      .filter(x => x != "");
    ...
    for (const player of team1) {
      ...
      if (!playerObj) {
        let embed = new EmbedBuilder()
          .setDescription("**Err:** " + player + " is not registered with the bot, make sure they've signed up!")
