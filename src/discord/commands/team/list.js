...
module.exports = {
  data: new SlashCommandSubcommandBuilder().setName('list').setDescription('List the teams'),
  async execute(interaction) {
    ...
    if (!tournament) {
      let embed = new EmbedBuilder().setDescription('**Err**: There is no active tournament');
