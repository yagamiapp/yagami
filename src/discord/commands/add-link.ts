...
export const data = new SlashCommandBuilder()
  ...
  .addStringOption((option) =>
    option.setName('link').setDescription('The link to your match').setRequired(true),
  );
...
export const execute = async (interaction: CommandInteraction) => {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`${emotes.loading} We're currently setting up your match...`)
    .setColor('#F88000');
  ...
  embed
    ...
    .setDescription(`${emotes.success} Check your invite message for more info`);
...
const getMatchWithUser = (userId: string) =>
