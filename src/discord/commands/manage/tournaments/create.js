  ...
  async execute(interaction) {
    ...
    if (duplicate) {
      let embed = new EmbedBuilder()
        .setDescription(`**Err**: A tournament with the acronym \`${acronym}\` already exists.`)
        .setColor(Colors.Red);
    ...
    let tournament = await prisma.tournament.create({
      data: {
        ...
        banner_url: 'https://yagami.clxxiii.dev/icons/white-gradient.png',
        ...
        icon_url:
          interaction.options.getString('icon_url') ?? 'https://yagami.clxxiii.dev/icons/logo.png',
