...
module.exports = {
  ...
  async execute(interaction) {
    ...
    let embed = new EmbedBuilder()
      ...
      .setThumbnail(
        active_tournament.icon_url || 'https://yagami.clxxiii.dev/static/yagami%20var.png'
      )
    ...
    for (const key in active_tournament) {
      ...
      let ignoredProps = ['icon_url', 'color', 'name', 'id', 'Guild_id', 'acronym', 'banner_url'];
      if (ignoredProps.includes(key) || key.includes('multiplier')) continue;
