...
import { BanchoChannel, BanchoLobby, BanchoLobbyPlayer, BanchoMultiplayerChannel, ChannelMessage } from "bancho.js"
...
export const payloadHandler = async (payload: ReturnValue, match: Match, channel: BanchoChannel) => {
