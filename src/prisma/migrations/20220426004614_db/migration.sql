...
INSERT INTO "new_Map" ("approved", "approved_date", "artist", "artist_unicode", "audio_unavailable", "beatmap_id", "beatmapset_id", "bpm", "count_normal", "count_slider", "count_spinner", "creator", "creator_id", "diff_aim", "diff_approach", "diff_drain", "diff_overall", "diff_size", "difficultyrating", "download_unavailable", "favorite_count", "file_md5", "genre_id", "globalMappoolId", "hit_length", "id", "identifier", "language_id", "last_update", "max_combo", "mode", "mods", "packs", "passcount", "playcount", "rating", "roundId", "source", "storyboard", "submit_date", "tags", "title", "title_unicode", "total_length", "version", "video") SELECT "approved", "approved_date", "artist", "artist_unicode", "audio_unavailable", "beatmap_id", "beatmapset_id", "bpm", "count_normal", "count_slider", "count_spinner", "creator", "creator_id", "diff_aim", "diff_approach", "diff_drain", "diff_overall", "diff_size", "difficultyrating", "download_unavailable", "favorite_count", "file_md5", "genre_id", "globalMappoolId", "hit_length", "id", "identifier", "language_id", "last_update", "max_combo", "mode", "mods", "packs", "passcount", "playcount", "rating", "roundId", "source", "storyboard", "submit_date", "tags", "title", "title_unicode", "total_length", "version", "video" FROM "Map";
DROP TABLE "Map";
