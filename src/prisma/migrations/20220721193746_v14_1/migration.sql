/*
  ...
  - You are about to alter the column `discord_createdTimestamp` on the `User` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
